...
export const metadata: Metadata = {
  title: "Contacto",
  description: "Contáctanos para solicitar una cotización o resolver tus dudas.",
};
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-16">
      ...
      <p className="mx-auto mt-4 max-w-2xl text-center text-slate-600">
        Estamos listos para ayudarte. Envíanos un mensaje o contáctanos por
        WhatsApp.
      </p>
      ...
      <div className="mt-12 grid gap-12 md:grid-cols-2">
        ...
        <div>
          ...
          <div className="space-y-6">
            ...
            <div>
              <h3 className="font-medium text-slate-900">Horario</h3>
